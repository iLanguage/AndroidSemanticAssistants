...
This option found under the Semantic Assistants menu in ``Global Settings''
allows the ability to enable/disable filtering of empty valued features in
side-nodes. This can be useful to avoid cluttering or aid debugging annotations
respectivelly.
