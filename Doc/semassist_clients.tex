...
order to offer various Natural Language Processing services. The Eclipse
Semantic Assistants plug-in is basically a Java archive (JAR) file that ships
...
\subsubsection{Plug-in Directory Structure}
\begin{enumerate}
...
project to communicate to the server.
...
code. The internal structure of this directory is further explained in the next
section.
\end{enumerate}

There is also another file called \url{plugin.xml} in this directory. This file
...
introcude the plug-in to Eclipse plug-in loader. By using this file, you can
test the plug-in inside an Eclipse runtime application.
